...
import com.o7solutions.meetnote.databinding.FragmentViewMeetingBinding
 ...
 * Use the [ViewMeetingFragment.newInstance] factory method to
...
class ViewMeetingFragment : Fragment() {
    ...
    private lateinit var binding: FragmentViewMeetingBinding
...
//        return inflater.inflate(R.layout.fragment_view_meeting, container, false)
        binding = FragmentViewMeetingBinding.inflate(layoutInflater)
        return binding.root
    }
